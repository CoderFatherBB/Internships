...
class Application(tk.Frame): 
    ...
    def build_interface(self):
        ...
        self.message = tk.Label(self, text="Enter in seconds", font = ("Courier", 10), width=20)
        ...
        self.reset_button.grid(row=5, column=0, sticky="NW")
        ...
        self.pause_button.grid(row = 5,column=3, sticky = "NW")
